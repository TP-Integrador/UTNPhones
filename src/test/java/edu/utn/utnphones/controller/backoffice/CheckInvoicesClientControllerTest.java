...
public class CheckInvoicesClientControllerTest {
    ...
    public void setUp(){
        ...
        checkInvoicesClientController = new CheckInvoicesClientController(invoiceController,sessionManager);
    }
    ...
    public void testGetInvoicesByClientOk(){
        ...
        ResponseEntity<List<Invoice>> responseEntity = checkInvoicesClientController.getInvoicesByClient("token",1);
    ...
    public void testGetInvoicesByClientNull(){
        ...
        ResponseEntity<List<Invoice>> responseEntity = checkInvoicesClientController.getInvoicesByClient("token",null);
    ...
    public void testGetInvoicesByDateOk() throws ParseException, UserNotexistException {
        ...
        ResponseEntity<List<Invoice>> responseEntity = checkInvoicesClientController.getInvoicesByDate("token","2020-05-28","2020-06-30",1);
    ...
    public void testGetInvoicesByDateNull() throws ParseException, UserNotexistException {
        ...
        ResponseEntity<List<Invoice>> responseEntity = checkInvoicesClientController.getInvoicesByDate("token",null,null,1);
    ...
    public void testGetInvoicesByDateNullFrom() throws ParseException, UserNotexistException {
        ...
        ResponseEntity<List<Invoice>> responseEntity = checkInvoicesClientController.getInvoicesByDate("token",null,"2020-06-30",1);
    ...
    public void testGetInvoicesByDateNullTo() throws ParseException, UserNotexistException {
        ...
        ResponseEntity<List<Invoice>> responseEntity = checkInvoicesClientController.getInvoicesByDate("token","2020-05-28",null,1);
