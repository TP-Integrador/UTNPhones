...
public class UserServiceTest {
    ...
    public void testLoginOk() throws UserNotexistException, ValidationException {
        User loggedUser = new User(1, "nme", "lastname", "12345678", "user", "pwd", true, City.builder().cityId(1).build(), UserType.builder().Id(1).build(), null);

        String pass = HashPwd.Encriptar("pwd");
        when(dao.getByUsername("user", pass)).thenReturn(loggedUser);
        ...
        verify(dao, times(1)).getByUsername("user", pass);
    }
